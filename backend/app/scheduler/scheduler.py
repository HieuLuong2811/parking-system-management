...
def start_scheduler() -> None:
    ...
    # Allow small delays (startup, event-loop hiccups, VM sleep) without logging a misfire.
    # Coalesce ensures that if multiple runs were missed while the process was down,
    # APScheduler will only run once on resume.
    job_defaults = {
